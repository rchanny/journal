...
def get_redirect_url(course_key, usage_key, request=None):
    ...
    if chapter is None:
        redirect_url = reverse('journalentry', args=(six.text_type(course_key), ))
    elif section is None:
        redirect_url = reverse('journalentry_chapter', args=(six.text_type(course_key), chapter))
