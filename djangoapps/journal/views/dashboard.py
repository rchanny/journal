...
from ..courses import check_course_access_with_redirect, get_course_with_access
...
# Disable lookup of Enterprise consent_required_course due to ENT-727
    ...
    # Sambaash added
    reflected_courses = []
    for course_object in course_enrollments:
        course = course_object.course
        modules = StudentModule.objects.filter(course_id__contains=course, student=request.user)
        has_text = False
